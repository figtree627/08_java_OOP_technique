...
class AccessModifierTest {
	...
	// private 변수를 클래스 외부로 반환하는 메서드 getter
	public int getA() { // 변수명 앞에 get을 추가하여 메서드이름을 작성한다.
		return this.a;
	}
	
	// private 변수를 클래스 외부에서 수정하는 메서드 setter
	public void setA(int a) { // 변수명 앞에 set을 추가하여 메서드이름을 작성한다.
		this.a = a;
	}
...
public class TechniqueEx02_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(object.getA()); // getter를 사용하여 private변수 데이터를 반환한다.
